...
export default function Index({
    ...
    const handleToggleStatus = (id: number) => {
        router.patch(
            `/outlets/${outlet.id}/chairs/${id}/status`,
            {},
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                            ...
                            {chairs.data.length === 0 ? (
                                ...
                                chairs.data.map((chair) => (
                                    <TableRow key={chair.id}>
                                        ...
                                        <TableCell>
                                            <span
                                                className={`rounded-full px-2 py-1 text-xs font-medium ${chair.is_active === '1' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}
                                            >
                                                {chair.is_active === '1'
                                                    ? 'Active'
                                                    : 'Inactive'}
                ...
                <div className="flex items-center justify-between">
                    <div className="ml-2 flex items-center gap-4 py-4 text-sm text-muted-foreground">
                        ...
                        <span>
                            Showing {chairs.from || 0} to {chairs.to || 0} of{' '}
                            {chairs.total || 0} entries
                        </span>
                    </div>
