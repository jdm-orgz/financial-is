    ...
    useEffect(() => {
        ...
        const timeoutId = setTimeout(() => {
            router.get(
                ...
                { ...filters, search, roles: roleNames, per_page },
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                            ...
                            {linkedOutletUsers.data.length === 0 ? (
                                ...
                                linkedOutletUsers.data.map((user) => (
                                    <TableRow
                                        ...
                                        onClick={() =>
                                            router.get(
                                                `/linked-outlet-users/${user.id}/edit`,
                                            )
                                        }
                                    >
                                        ...
                                        <TableCell className="text-right">
                                            <div className="flex items-center justify-end gap-3">
                                                ...
                                                >
                                                    <Link
                                                        href={`/linked-outlet-users/${user.id}/edit`}
                                                    >
                ...
                <div className="flex items-center justify-between">
                    <div className="ml-2 flex items-center gap-4 py-4 text-sm text-muted-foreground">
                        ...
                        <span>
                            Showing {linkedOutletUsers.from || 0} to{' '}
                            {linkedOutletUsers.to || 0} of{' '}
                            {linkedOutletUsers.total || 0} entries
                        </span>
                    </div>
